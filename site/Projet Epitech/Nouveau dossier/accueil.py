...
<body>
	...
	<h2 class="categorie_produit">Les meilleurs ventes :</h2>

<div class="tableau">
		<table>
			<tr>
				<td  width="10%">
						<a href="article.py?item=0"><img src="cgi-bin/masqueChirurgical.png" class="imageTop"></a>
				</td>
				<td width="10%">
					<a href="article.py?item=10"><img src="cgi-bin/masqueTissu.png" class="imageTop"></a>
			</tr>
			<tr>
				<td width="25%">
					<a href="article.py?item=15"><img src="cgi-bin/gell.png" class="imageTop"></a>
				</td>
				<td width="10%">
					<a href="article.py?item=23"><img src="cgi-bin/porteCle.png" class="imageTop"></a>
				</td>
			</tr>
		</table>
	</div>
    <br>
    <a href="geste.py" style="color:#000000;">Rappel des gestes barrières</a>
</body>
</html>
"""
else:
